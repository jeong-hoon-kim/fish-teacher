...
### 1. 14종의 한국 연안 주요 어종 판독 (YOLOv8 Pose)
- **우점 어종 및 신규 14종 완벽 학습:** 감성돔, 참돔, 조피볼락(우럭), 넙치(광어), 돌돔, 성대, 학꽁치, 흑점줄전갱이, 보리멸, 방어, 숭어, 고등어, 삼치, 말쥐치 등 국내 연안 및 민물의 핵심 어종을 정확히 분류합니다.
- **학습 데이터 오버샘플링(Oversampling) 적용:** 원본 수량이 적은 소수 어종에 대해 학습 데이터셋 내에서 복제 가중치(최대 10배)를 적용하여 데이터 불균형을 극복하고 **포즈 mAP50-95 기준 89.5%**의 압도적인 키포인트 정확도를 자랑합니다.
